...
export interface CWemixDollarInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "owner"
      | "supportsInterface"
...
export interface CWemixDollar extends BaseContract {
  connect(runner?: ContractRunner | null): CWemixDollar;
  waitForDeployment(): Promise<this>;

  interface: CWemixDollarInterface;
