...
const _abi = [
  ...
  },
  {
    ...
    name: "getCurrentMyIncentiveToken",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "enum ControllerErrorReport.Error",
        name: "",
        type: "uint8",
      },
      {
  ...
  },
  {
    ...
    name: "getLiquidationIncentiveOf",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  {
    inputs: [],
    name: "incentiveTokenInitialIndex",
    outputs: [
      {
...
type ControllerViewConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: ControllerViewConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class ControllerView__factory extends ContractFactory {
  constructor(...args: ControllerViewConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): ControllerView__factory {
    return super.connect(runner) as ControllerView__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): ControllerViewInterface {
    return new Interface(_abi) as ControllerViewInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ControllerView {
    return new Contract(address, _abi, runner) as unknown as ControllerView;
  }
}
