...
import type { CWemixDollar, CWemixDollarInterface } from "../CWemixDollar";
...
type CWemixDollarConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: CWemixDollarConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class CWemixDollar__factory extends ContractFactory {
  constructor(...args: CWemixDollarConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): CWemixDollar__factory {
    return super.connect(runner) as CWemixDollar__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): CWemixDollarInterface {
    return new Interface(_abi) as CWemixDollarInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): CWemixDollar {
    return new Contract(address, _abi, runner) as unknown as CWemixDollar;
  }
}
