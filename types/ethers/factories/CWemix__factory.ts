...
import type { CWemix, CWemixInterface } from "../CWemix";
...
type CWemixConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: CWemixConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class CWemix__factory extends ContractFactory {
  constructor(...args: CWemixConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): CWemix__factory {
    return super.connect(runner) as CWemix__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): CWemixInterface {
    return new Interface(_abi) as CWemixInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): CWemix {
    return new Contract(address, _abi, runner) as unknown as CWemix;
  }
}
