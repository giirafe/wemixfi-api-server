...
export interface CWemixInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "owner"
      | "supportsInterface"
...
export interface CWemix extends BaseContract {
  connect(runner?: ContractRunner | null): CWemix;
  waitForDeployment(): Promise<this>;

  interface: CWemixInterface;
  ...
  addReserves: TypedContractMethod<[], [bigint], "payable">;
  ...
  mintHelper: TypedContractMethod<[caller: AddressLike], [bigint], "payable">;
  ...
  repayBorrow: TypedContractMethod<[], [[bigint, bigint]], "payable">;
  ...
  ): TypedContractMethod<[caller: AddressLike], [bigint], "payable">;
  getFunction(
