...
export class PoolController {
    ...
    async removeLiquidity(
        ...
        try {
            return await this.poolService.removeLiquidity(msgSender,tokenA, tokenB, liquidity, amountAMin, amountBMin, to, deadline);
        } catch (error) {
            throw new HttpException({
                status: HttpStatus.INTERNAL_SERVER_ERROR,
    ...
    async removeLiquidityWEMIX(
        ...
        try {
            return await this.poolService.removeLiquidityWEMIX(msgSender, token, liquidity, amountTokenMin, amountWEMIXMin, to, deadline);
        } catch (error) {
            throw new HttpException({
                status: HttpStatus.INTERNAL_SERVER_ERROR,
